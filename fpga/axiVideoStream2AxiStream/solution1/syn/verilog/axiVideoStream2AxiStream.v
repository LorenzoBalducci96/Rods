...
module axiVideoStream2AxiStream (
        ap_clk,
        ap_rst_n,
        ap_start,
        ap_done,
...
wire   [31:0] tmp_3_fu_177_p2;
reg   [31:0] width_count_new_reg_109;
wire   [0:0] tmp_4_fu_183_p2;
reg    ap_block_state2;
wire   [31:0] p_s_fu_201_p3;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_853)) begin
        if ((tmp_4_fu_183_p2 == 1'd0)) begin
            width_count_new_reg_109 <= tmp_3_fu_177_p2;
        end else if ((tmp_4_fu_183_p2 == 1'd1)) begin
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (1'b0 == OUTPUT_STREAM_V_data_V_1_ack_in) | (1'b0 == INPUT_STREAM_V_data_V_0_vld_out)) & (tmp_4_fu_183_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign p_s_fu_201_p3 = ((tmp_6_fu_195_p2[0:0] === 1'b1) ? 32'd0 : tmp_5_fu_189_p2);

assign tmp_1_fu_154_p2 = ((width_count == 32'd319) ? 1'b1 : 1'b0);

assign tmp_2_fu_164_p2 = ((height_count == 32'd239) ? 1'b1 : 1'b0);

assign tmp_3_fu_177_p2 = (width_count + 32'd1);

assign tmp_4_fu_183_p2 = ((tmp_3_fu_177_p2 == 32'd320) ? 1'b1 : 1'b0);

assign tmp_5_fu_189_p2 = (height_count + 32'd1);

assign tmp_6_fu_195_p2 = ((tmp_5_fu_189_p2 == 32'd240) ? 1'b1 : 1'b0);

assign tmp_last_V_fu_170_p2 = (tmp_2_fu_164_p2 & tmp_1_fu_154_p2);

endmodule //axiVideoStream2AxiStream
