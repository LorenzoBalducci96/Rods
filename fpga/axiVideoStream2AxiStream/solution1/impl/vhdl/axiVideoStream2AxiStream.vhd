...
entity axiVideoStream2AxiStream is
port (
    ap_clk : IN STD_LOGIC;
...
architecture behav of axiVideoStream2AxiStream is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "axiVideoStream2AxiStream,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.794000,HLS_SYN_LAT=1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=204,HLS_SYN_LUT=700,HLS_VERSION=2018_3}";
    ...
    signal tmp_3_fu_177_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal width_count_new_reg_109 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_4_fu_183_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state2 : BOOLEAN;
    signal p_s_fu_201_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1_fu_154_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_2_fu_164_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_5_fu_189_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_6_fu_195_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_853)) then
                if ((tmp_4_fu_183_p2 = ap_const_lv1_0)) then 
                    width_count_new_reg_109 <= tmp_3_fu_177_p2;
                elsif ((tmp_4_fu_183_p2 = ap_const_lv1_1)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = OUTPUT_STREAM_V_last_V_1_load_A)) then
                OUTPUT_STREAM_V_last_V_1_payload_A <= tmp_last_V_fu_170_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = OUTPUT_STREAM_V_last_V_1_load_B)) then
                OUTPUT_STREAM_V_last_V_1_payload_B <= tmp_last_V_fu_170_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_start = ap_const_logic_0) or (ap_const_logic_0 = OUTPUT_STREAM_V_data_V_1_ack_in) or (ap_const_logic_0 = INPUT_STREAM_V_data_V_0_vld_out))) and (tmp_4_fu_183_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                height_count <= p_s_fu_201_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    INPUT_STREAM_V_user_V_0_ack_out_assign_proc : process(ap_start, ap_CS_fsm_state1, INPUT_STREAM_V_data_V_0_vld_out, OUTPUT_STREAM_V_data_V_1_ack_in)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_const_logic_0 = OUTPUT_STREAM_V_data_V_1_ack_in) or (ap_const_logic_0 = INPUT_STREAM_V_data_V_0_vld_out))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    p_s_fu_201_p3 <= 
        ap_const_lv32_0 when (tmp_6_fu_195_p2(0) = '1') else 
        tmp_5_fu_189_p2;
    tmp_1_fu_154_p2 <= "1" when (width_count = ap_const_lv32_13F) else "0";
    tmp_2_fu_164_p2 <= "1" when (height_count = ap_const_lv32_EF) else "0";
    tmp_3_fu_177_p2 <= std_logic_vector(unsigned(width_count) + unsigned(ap_const_lv32_1));
    tmp_4_fu_183_p2 <= "1" when (tmp_3_fu_177_p2 = ap_const_lv32_140) else "0";
    tmp_5_fu_189_p2 <= std_logic_vector(unsigned(height_count) + unsigned(ap_const_lv32_1));
    tmp_6_fu_195_p2 <= "1" when (tmp_5_fu_189_p2 = ap_const_lv32_F0) else "0";
    tmp_last_V_fu_170_p2 <= (tmp_2_fu_164_p2 and tmp_1_fu_154_p2);
end behav;
