...
(* CORE_GENERATION_INFO="axis_to_axiVideoStream,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.794000,HLS_SYN_LAT=1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=198,HLS_SYN_LUT=698,HLS_VERSION=2018_3}" *)
...
reg    ap_block_state1;
wire   [0:0] tmp_user_V_fu_159_p2;
wire   [0:0] tmp_last_V_fu_178_p2;
wire   [31:0] tmp_6_fu_185_p2;
reg   [31:0] width_count_new_reg_109;
wire   [0:0] tmp_7_fu_191_p2;
reg    ap_block_state2;
wire   [31:0] p_s_fu_209_p3;
wire   [31:0] tmp_1_fu_153_p2;
wire   [0:0] tmp_3_fu_166_p2;
wire   [0:0] not_tmp_2_fu_172_p2;
wire   [31:0] tmp_8_fu_197_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_853)) begin
        if ((tmp_7_fu_191_p2 == 1'd0)) begin
            width_count_new_reg_109 <= tmp_6_fu_185_p2;
        end else if ((tmp_7_fu_191_p2 == 1'd1)) begin
            width_count_new_reg_109 <= 32'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (1'b0 == OUTPUT_STREAM_V_data_V_1_ack_in) | (1'b0 == INPUT_STREAM_V_data_V_0_vld_out)) & (tmp_7_fu_191_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
        height_count <= p_s_fu_209_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((~((1'b0 == OUTPUT_STREAM_V_dest_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_id_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_last_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_user_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_strb_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_keep_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_data_V_1_ack_in)) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (1'b0 == OUTPUT_STREAM_V_data_V_1_ack_in) | (1'b0 == INPUT_STREAM_V_data_V_0_vld_out)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((1'b0 == OUTPUT_STREAM_V_dest_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_id_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_last_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_user_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_strb_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_keep_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_data_V_1_ack_in)) & (OUTPUT_STREAM_V_dest_V_1_state[1'd0] == 1'b0) & (OUTPUT_STREAM_V_id_V_1_state[1'd0] == 1'b0) & (OUTPUT_STREAM_V_last_V_1_state[1'd0] == 1'b0) & (OUTPUT_STREAM_V_user_V_1_state[1'd0] == 1'b0) & (OUTPUT_STREAM_V_strb_V_1_state[1'd0] == 1'b0) & (OUTPUT_STREAM_V_keep_V_1_state[1'd0] == 1'b0) & (OUTPUT_STREAM_V_data_V_1_state[1'd0] == 1'b0) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (1'b0 == INPUT_STREAM_V_data_V_0_vld_out));
end

always @ (*) begin
    ap_block_state2 = ((1'b0 == OUTPUT_STREAM_V_dest_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_id_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_last_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_user_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_strb_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_keep_V_1_ack_in) | (1'b0 == OUTPUT_STREAM_V_data_V_1_ack_in));
end

always @ (*) begin
    ap_condition_853 = (~((ap_start == 1'b0) | (1'b0 == OUTPUT_STREAM_V_data_V_1_ack_in) | (1'b0 == INPUT_STREAM_V_data_V_0_vld_out)) & (1'b1 == ap_CS_fsm_state1));
end
...
assign not_tmp_2_fu_172_p2 = (tmp_user_V_fu_159_p2 ^ 1'd1);

assign p_s_fu_209_p3 = ((tmp_9_fu_203_p2[0:0] === 1'b1) ? 32'd0 : tmp_8_fu_197_p2);

assign tmp_1_fu_153_p2 = (width_count | height_count);

assign tmp_3_fu_166_p2 = ((width_count == 32'd319) ? 1'b1 : 1'b0);

assign tmp_6_fu_185_p2 = (width_count + 32'd1);

assign tmp_7_fu_191_p2 = ((tmp_6_fu_185_p2 == 32'd320) ? 1'b1 : 1'b0);

assign tmp_8_fu_197_p2 = (height_count + 32'd1);

assign tmp_9_fu_203_p2 = ((tmp_8_fu_197_p2 == 32'd240) ? 1'b1 : 1'b0);

assign tmp_last_V_fu_178_p2 = (tmp_3_fu_166_p2 & not_tmp_2_fu_172_p2);

assign tmp_user_V_fu_159_p2 = ((tmp_1_fu_153_p2 == 32'd0) ? 1'b1 : 1'b0);

endmodule //axis_to_axiVideoStream
