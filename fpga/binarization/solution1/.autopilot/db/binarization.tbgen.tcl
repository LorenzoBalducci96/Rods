...
set C_modelArgList {
	...
	{ threshold uint 8 regular  }
	{ update_threshold_V int 1 regular  }
	{ inverted_V int 1 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "INPUT_STREAM_V_data_V", "interface" : "axis", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "INPUT_STREAM.V.data.V","cData": "uint8","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "threshold", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "threshold","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	{ "Name" : "update_threshold_V", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "update_threshold.V","cData": "uint1","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	{ "Name" : "inverted_V", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "inverted.V","cData": "uint1","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
...
set portList { 
	...
	{ update_threshold_V sc_in sc_lv 1 signal 8 } 
	{ inverted_V sc_in sc_lv 1 signal 9 } 
	{ OUTPUT_STREAM_TDATA sc_out sc_lv 8 signal 10 } 
	{ OUTPUT_STREAM_TVALID sc_out sc_logic 1 outvld 16 } 
	{ OUTPUT_STREAM_TREADY sc_in sc_logic 1 outacc 10 } 
	{ OUTPUT_STREAM_TKEEP sc_out sc_lv 1 signal 11 } 
	{ OUTPUT_STREAM_TSTRB sc_out sc_lv 1 signal 12 } 
	{ OUTPUT_STREAM_TUSER sc_out sc_lv 1 signal 13 } 
	{ OUTPUT_STREAM_TLAST sc_out sc_lv 1 signal 14 } 
	{ OUTPUT_STREAM_TID sc_out sc_lv 1 signal 15 } 
	{ OUTPUT_STREAM_TDEST sc_out sc_lv 1 signal 16 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "update_threshold_V", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "update_threshold_V", "role": "default" }} , 
 	{ "name": "inverted_V", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "inverted_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "update_threshold_V", "Type" : "None", "Direction" : "I"},
			{"Name" : "inverted_V", "Type" : "None", "Direction" : "I"},
			...
			{"Name" : "threshold_memorized", "Type" : "OVld", "Direction" : "IO"}]}]}
...
set ArgLastReadFirstWriteLatency {
	binarization {
		...
		update_threshold_V {Type I LastRead 0 FirstWrite -1}
		inverted_V {Type I LastRead 0 FirstWrite -1}
		...
		threshold_memorized {Type IO LastRead -1 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	update_threshold_V { ap_none {  { update_threshold_V in_data 0 1 } } }
	inverted_V { ap_none {  { inverted_V in_data 0 1 } } }
