# ==============================================================
# File generated on Wed Aug 05 17:49:17 +0200 2020
...
HLS_SOURCES = ../../../test_bench.cpp ../../../binarization.cpp
...
$(ObjDir)/binarization.o: ../../../binarization.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../binarization.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/binarization.d
