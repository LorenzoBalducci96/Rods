...
// ==============================================================
#ifndef __contours_finder_ulbW__HH__
#define __contours_finder_ulbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(contours_finder_ulbW) {
    ...
    SC_CTOR(contours_finder_ulbW):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
