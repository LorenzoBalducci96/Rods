...
// ==============================================================
#ifndef __image_filter_ama_rcU__HH__
#define __image_filter_ama_rcU__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_ama_rcU) {
    ...
    SC_CTOR(image_filter_ama_rcU):  simcore_ama_1_U ("simcore_ama_1_U") {
