...
// ==============================================================
#ifndef __image_filter_ama_udo__HH__
#define __image_filter_ama_udo__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_ama_udo) {
    ...
    SC_CTOR(image_filter_ama_udo):  simcore_ama_4_U ("simcore_ama_4_U") {
