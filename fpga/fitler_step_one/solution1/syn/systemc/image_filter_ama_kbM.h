...
// ==============================================================
#ifndef __image_filter_ama_kbM__HH__
#define __image_filter_ama_kbM__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_ama_kbM) {
    ...
    SC_CTOR(image_filter_ama_kbM):  simcore_ama_0_U ("simcore_ama_0_U") {
