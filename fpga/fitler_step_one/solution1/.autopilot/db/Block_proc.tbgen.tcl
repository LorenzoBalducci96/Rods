...
set C_modelArgList {
	{ img_input_rows_V_out int 11 regular {fifo 1}  }
	{ img_input_cols_V_out int 11 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "img_input_rows_V_out", "interface" : "fifo", "bitwidth" : 11, "direction" : "WRITEONLY"} , 
 	{ "Name" : "img_input_cols_V_out", "interface" : "fifo", "bitwidth" : 11, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ img_input_rows_V_out_din sc_out sc_lv 11 signal 0 } 
	{ img_input_rows_V_out_full_n sc_in sc_logic 1 signal 0 } 
	{ img_input_rows_V_out_write sc_out sc_logic 1 signal 0 } 
	{ img_input_cols_V_out_din sc_out sc_lv 11 signal 1 } 
	{ img_input_cols_V_out_full_n sc_in sc_logic 1 signal 1 } 
	{ img_input_cols_V_out_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "img_input_rows_V_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "img_input_rows_V_out", "role": "din" }} , 
 	...
 	{ "name": "img_input_cols_V_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "img_input_cols_V_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	img_input_rows_V_out { ap_fifo {  { img_input_rows_V_out_din fifo_data 1 11 }  { img_input_rows_V_out_full_n fifo_status 0 1 }  { img_input_rows_V_out_write fifo_update 1 1 } } }
	img_input_cols_V_out { ap_fifo {  { img_input_cols_V_out_din fifo_data 1 11 }  { img_input_cols_V_out_full_n fifo_status 0 1 }  { img_input_cols_V_out_write fifo_update 1 1 } } }
}
