...
wire [7:0]  output_V_data_V_dout;
wire [0:0]  output_V_data_V_empty_n;
wire [0:0]  output_V_keep_V_dout;
wire [0:0]  output_V_keep_V_empty_n;
wire [0:0]  output_V_strb_V_dout;
...
assign TDATA  = m_data[7:0];
assign TKEEP  = m_data[8:8];
assign TSTRB  = m_data[9:9];
assign TUSER  = m_data[10:10];
assign TLAST  = m_data[11:11];
assign TID    = m_data[12:12];
assign TDEST  = m_data[13:13];
