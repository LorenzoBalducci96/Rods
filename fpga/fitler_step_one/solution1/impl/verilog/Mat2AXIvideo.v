...
reg   [9:0] t_V_1_reg_129;
wire   [0:0] exitcond4_fu_145_p2;
wire    ap_CS_fsm_state2;
wire   [9:0] i_V_fu_151_p2;
reg   [9:0] i_V_reg_195;
...
wire   [9:0] j_V_fu_163_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] axi_last_V_fu_169_p2;
reg   [0:0] axi_last_V_reg_209;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond4_fu_145_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((exitcond4_fu_145_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_157_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_157_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((exitcond_fu_157_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((exitcond4_fu_145_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((exitcond_fu_157_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((exitcond_fu_157_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_reg_200 == 1'd0) & (1'b0 == AXI_video_strm_V_id_V1_status)) | ((exitcond_reg_200 == 1'd0) & (img_data_stream_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_reg_200 == 1'd0) & (1'b0 == AXI_video_strm_V_id_V1_status)) | ((exitcond_reg_200 == 1'd0) & (img_data_stream_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_reg_200 == 1'd0) & (1'b0 == AXI_video_strm_V_id_V1_status)) | ((exitcond_reg_200 == 1'd0) & (img_data_stream_V_empty_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = (((exitcond_reg_200 == 1'd0) & (1'b0 == AXI_video_strm_V_id_V1_status)) | ((exitcond_reg_200 == 1'd0) & (img_data_stream_V_empty_n == 1'b0)));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign axi_last_V_fu_169_p2 = ((t_V_1_reg_129 == 10'd511) ? 1'b1 : 1'b0);

assign exitcond4_fu_145_p2 = ((t_V_reg_118 == 10'd512) ? 1'b1 : 1'b0);

assign exitcond_fu_157_p2 = ((t_V_1_reg_129 == 10'd512) ? 1'b1 : 1'b0);

assign i_V_fu_151_p2 = (t_V_reg_118 + 10'd1);

assign j_V_fu_163_p2 = (t_V_1_reg_129 + 10'd1);
