# ==============================================================
# File generated on Thu Aug 06 12:39:28 +0200 2020
...
HLS_SOURCES = ../../../test_bench.cpp ../../../otsu.cpp
...
$(ObjDir)/otsu.o: ../../../otsu.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../otsu.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/otsu.d
