...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("best_threshold", 8, hls_out, 14, "ap_vld", "out_data", 1),
	Port_Property("best_threshold_ap_vld", 1, hls_out, 14, "ap_vld", "out_vld", 1),
	Port_Property("updateThreshold_V", 1, hls_out, 15, "ap_none", "out_data", 1),
};
const char* HLS_Design_Meta::dut_name = "otsu";
