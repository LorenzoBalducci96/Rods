...
// ==============================================================
#ifndef __otsu_udiv_32ns_32bkb__HH__
#define __otsu_udiv_32ns_32bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(otsu_udiv_32ns_32bkb) {
    ...
    SC_CTOR(otsu_udiv_32ns_32bkb):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
